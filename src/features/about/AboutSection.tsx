          ...
          <Card className="bg-primary bg-opacity-50 px-3 mt-10 py-4">
            <Tabs defaultValue="about" className="">
              <TabsList className="w-full gap-3  flex justify-start">
                <TabsTrigger className="px-9  bg-white py-2" value="about">
                  About
                </TabsTrigger>
                <TabsTrigger className="px-9   bg-white py-2" value="mission">
                  Mission
                </TabsTrigger>
                <TabsTrigger className="px-9  bg-white py-2" value="vision">
                  Vision
                </TabsTrigger>
              </TabsList>
